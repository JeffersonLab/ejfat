...
namespace ejfat {
     ...
     */
    template <class T> Supplier<T>::Supplier() :
            Supplier(16, false) {
    }
     ...
     */
    template <class T> Supplier<T>::Supplier(int ringSize, bool orderedRelease) :
...
//        T::setEventFactorySettings(order, bufferSize, orderedRelease);
     ...
     * and exit.
     */
    template <class T> void Supplier<T>::errorAlert() const {
        barrier->alert();
    }
     ...
     */
    template <class T> uint32_t Supplier<T>::getMaxRingBytes() const {
     ...
     */
    template <class T> uint32_t Supplier<T>::getRingSize() const {return ringSize;}
     ...
     */
    template <class T> uint64_t Supplier<T>::getFillLevel() const {
     ...
     */
    template <class T> int64_t Supplier<T>::getLastSequence() const {
     ...
     */
    template <class T> std::shared_ptr<T> Supplier<T>::get() {
     ...
     * @throws InterruptedException if thread interrupted.
     */
    template <class T> void Supplier<T>::get(int32_t n, std::shared_ptr<T> items[]) {
     ...
     * @throws InterruptedException if thread interrupted.
     */
    template <class T> std::shared_ptr<T> Supplier<T>::getAsIs() {
        // Next available item claimed by data producer
        long getSequence = ringBuffer->next();
     ...
     * @throws InterruptedException if thread interrupted.
     */
    template <class T> std::shared_ptr<T> Supplier<T>::consumerGet() {
     ...
     */
    template <class T> void Supplier<T>::release(std::shared_ptr<T> & item) {
     ...
     */
    template <class T> void Supplier<T>::publish(std::shared_ptr<T> & bufferSupplyItem) {
     ...
     */
    template <class T> void Supplier<T>::publish(int32_t n, std::shared_ptr<T> items[]) {
