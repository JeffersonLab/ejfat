...
/**
 * <p>
 * @file Add senders to list of those allowed to send to the specified LB.
 * </p>
 */
...
static void printHelp(char *programName) {
    ...
    fprintf(stderr, "        For the specified CP's LB, add to list of approved senders\n");
...
int main(int argc, char **argv) {
    ...
    int err = LbAdmin::AddSenders(cp_host, cp_port, lbid, adminToken, senders);
